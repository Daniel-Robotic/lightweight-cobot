...
Серый круглый индикатор — приложение выбрано и загружено в контроллер, однако ещё не запущено. Для запуска нажмите **Старт**.
...
Жёлтый индикатор паузы — выполнение прервано. Для возобновления нажмите **Старт**.
